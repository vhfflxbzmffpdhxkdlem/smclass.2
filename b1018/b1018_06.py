class Student:
  ...
  # 객체를 문자열로 리턴함수 - 리턴:문자열이 되어야 함.
  def __str__(self):    # 딕셔너리 타입으로 리턴
...
while True:
  ...
  elif choice == 3:  # 홍길동 학생합계, 유관순 학생의합계
...
print(s1)   # 0x000 -> __str__() 정의된 형태로 출력
