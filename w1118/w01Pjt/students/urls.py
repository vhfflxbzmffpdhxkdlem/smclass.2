...
urlpatterns = [
    ...
    ## 수정1,2,3 = 수정1
    path('<str:name>/modify/', views.modify,name='modify'), # 학생수정 1 - url
    path('modify2/', views.modify2,name='modify2'), # 학생수정 2 
    path('<str:name>/modify3/', views.modify3,name='modify3'), # 학생수정 3
    ## 삭제
