...
# html,css 접보를 가진 소스변경
soup = BeautifulSoup(res.text,"lxml")  # str -> html 태크,css태그 사용될수 있는 형태로 변경
...
print(soup.find("h2",{"class":"rankingnews_tit"}).text)  # h2태그 class="rankingnews_tit"을 출력
